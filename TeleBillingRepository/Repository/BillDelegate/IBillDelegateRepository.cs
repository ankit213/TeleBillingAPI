...
namespace TeleBillingRepository.Repository.BillDelegate
{
    public interface IBillDelegateRepository
    {
        ...
        /// <returns></returns>
        Task<ResponseAC> EditDelegate(BillDelegatesAC BillDelegatesAC, long userId);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        Task<ResponseAC> AddDelegate(BillDelegatesAC BillDelegatesAC, long userId);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        Task<bool> DeleteDelegate(long id, long userId);
